...
class Clustering:
    def __init__(self, df, algorithm:str=None, linkage_method:str=None, features:list=None):
        ...
        if features is not None:
            self.features = features + ["rolling_volatility", 'normalized_holders', "holders_adj", "holders_adj"]
        else: 
    ...
    def run_pipeline(self, eps=1.5, min_samples=5):
        """
